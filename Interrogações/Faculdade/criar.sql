...
CREATE TABLE prof (sigla PRIMARY KEY REFERENCES aluno (nr), Nome);
...
CREATE TABLE prova (nr INTEGER, cod TEXT REFERENCES cadeira (cod), data DATE, nota INTEGER, PRIMARY KEY (nr, cod, data));
